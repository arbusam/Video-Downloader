...
DUPLICATES = f"{Fore.WHITE}One or more of the URLs provided are either {Fore.RED}already in the table {Fore.RESET}or {Fore.RED}are duplicates in the file. Those URLs will not be added."
